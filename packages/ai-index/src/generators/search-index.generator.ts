...
export function generateSearchIndex(docs: SearchDocument[]): SearchIndex {
...
export function buildDefaultSearchIndex(): SearchIndex {
...
export function bm25Search(
  ...
  index: SearchIndex,
  topK = 3
): Array<{ id: string; score: number; title: string; path: string }> {
