...
function getButtonUsage(variant, useCase, platform = 'web') {
    if (platform === 'ios') {
        ...
        for (const [key, prop] of Object.entries(IOS_BUTTON_METADATA.props)) {
            const defaultVal = prop.default ? ` (기본값: ${prop.default})` : '';
...
function getTextUsage(useCase, platform = 'web') {
    if (platform === 'ios') {
...
function getIconUsage(keyword, platform = 'web') {
    if (platform === 'ios') {
